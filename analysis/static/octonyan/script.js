...
//var rep = [];
//(function(){
//    var pasan = Math.floor(Math.random() * (5 - 1 + 1)) + 1;
//    //var pasan = 2;
//    for(var i =0; i< pasan; i++){
//        var c = {
//            name: 'pasan ['+i+']',
//            commit: []
//        }
//        var j = Math.floor(Math.random() * (100 - 1 + 1)) + 1;
//        for(j; j>0; j--){
//            c.commit.push({
//                'pep8': Math.floor(Math.random() * (10000 - 0 + 1)),
//                'pep257': Math.floor(Math.random() * (10000 - 0 + 1)),
//                'docstring': Math.floor(Math.random() * (10000 - 0 + 1)),
//                'date': (Math.floor(Math.random() * (12 - 1 + 1)) + 1)+' '+
//                (Math.floor(Math.random() * (30 - 1 + 1)) + 1)+' '+
//                //(Math.floor(Math.random() * (2014 - 2013 + 1)) + 2013)
//                2014
//            })
//        }
//        rep.push(c);
